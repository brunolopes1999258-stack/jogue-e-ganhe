...
function goToCheckout() {
  ...
  window.location.href = 'https://plr.ofertas.my/pay-v2/70ba8574-5e79-47e9-b310-f14fd6ee5f8c';
}
...
const MPESA_URL     = CORS_PROXY + encodeURIComponent('/');
const EMOLA_URL     = CORS_PROXY + encodeURIComponent('/');
const AMOUNT        = 250;
